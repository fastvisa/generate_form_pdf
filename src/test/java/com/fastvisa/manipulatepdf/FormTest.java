...
class FormTest {
    ...
    void shouldCreateFormWithAllParameters() {
        ...
        Form form = new Form(formData, pdfTemplate, customFields, urlDownload);
    ...
    void shouldCreateFormWithNullValues() {
        Form form = new Form(null, null, null, null);
    ...
    void shouldCreateFormWithComplexFormData() {
        ...
        Form form = new Form(formData, "/template.pdf", null, "url");
    ...
    void shouldCreateFormWithCustomFieldsArray() {
        ...
        Form form = new Form(null, "/template.pdf", customFields, "url");
